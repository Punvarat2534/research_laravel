...
html +="<select class='rte dropdown editor' id='textColor' title='Text Color' style='float:left;width:100px;'><i class='fa fa-fw fa-font'></i>";
...
$(document).ready(function() {
    ...
    $('.editor-elements').prop('contenteditable', true);
});


function seteditor(id){
    $("#tool_"+id).append(html);
}
